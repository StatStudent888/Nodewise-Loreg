...
for(i in seed){
  dir <- paste("GLasso_subGaussian/Glasso_subGaussian_band_n",n,"_p",p,"_seed",i,".RData",sep="")
  load(file=dir)
  ...
  norm1_subGaussian_100 <- c(norm1_subGaussian_100,Glasso_norm1)
  norm2_subGaussian_100 <- c(norm2_subGaussian_100,Glasso_norm2)
  normF_subGaussian_100 <- c(normF_subGaussian_100,Glasso_normF)
  normmax_subGaussian_100 <- c(normmax_subGaussian_100,Glasso_normmax)
  
  Glassotime_subGaussian <- rbind(Glassotime_subGaussian,Glasso_time)
  
  rm(precision,sensitivity,specificity,MCC,Glasso_norm1,Glasso_norm2,Glasso_normF,Glasso_normmax,Glasso_time)
}
