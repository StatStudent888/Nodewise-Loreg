...
for(i in seed){
  dir <- paste("l1_desparsified_subGaussian_one-two-stage_lfdr/L1_desparsified_subGaussian_band_n",n,"_p",p,"_seed",i,"_one-two-stage_lfdr.RData",sep="")
  load(file=dir)
  ...
  norm1_min_100 <- c(norm1_min_100,NS_min_norm1)
  norm2_min_100 <- c(norm2_min_100,NS_min_norm2)
  normF_min_100 <- c(normF_min_100,NS_min_normF)
  normmax_min_100 <- c(normmax_min_100,NS_min_normmax)
  norm1_star_desparsified_min_method1_100 <- c(norm1_star_desparsified_min_method1_100,NS_norm1_T_star_desparsified_min_method1)
  norm2_star_desparsified_min_method1_100 <- c(norm2_star_desparsified_min_method1_100,NS_norm2_T_star_desparsified_min_method1)
  normF_star_desparsified_min_method1_100 <- c(normF_star_desparsified_min_method1_100,NS_normF_T_star_desparsified_min_method1)
  normmax_star_desparsified_min_method1_100 <- c(normmax_star_desparsified_min_method1_100,NS_normmax_T_star_desparsified_min_method1)
  
  norm1_star_desparsified_min_method2_100 <- c(norm1_star_desparsified_min_method2_100,NS_norm1_T_star_desparsified_min_method2)
  norm2_star_desparsified_min_method2_100 <- c(norm2_star_desparsified_min_method2_100,NS_norm2_T_star_desparsified_min_method2)
  normF_star_desparsified_min_method2_100 <- c(normF_star_desparsified_min_method2_100,NS_normF_T_star_desparsified_min_method2)
  normmax_star_desparsified_min_method2_100 <- c(normmax_star_desparsified_min_method2_100,NS_normmax_T_star_desparsified_min_method2)
  
  norm1_star_method3_100 <- c(norm1_star_method3_100,NS_norm1_T_star_method3)
  norm2_star_method3_100 <- c(norm2_star_method3_100,NS_norm2_T_star_method3)
  normF_star_method3_100 <- c(normF_star_method3_100,NS_normF_T_star_method3)
  normmax_star_method3_100 <- c(normmax_star_method3_100,NS_normmax_T_star_method3)
  ...
  rm(precision_min,
     ...
     NS_normF_T_star_method3,NS_normmax_T_star_method3)
}
...
x2 <- paste(sprintf("%0.3f",norm1_star_desparsified_min_method1_mean),"(",sprintf("%0.3f",norm1_star_desparsified_min_method1_sd),")"," & ",
...
x3 <- paste(sprintf("%0.3f",norm1_star_desparsified_min_method2_mean),"(",sprintf("%0.3f",norm1_star_desparsified_min_method2_sd),")"," & ",
...
x4 <- paste(sprintf("%0.3f",norm1_star_method3_mean),"(",sprintf("%0.3f",norm1_star_method3_sd),")"," & ",
...
x5 <- paste(sprintf("%0.3f",norm1_T_mean),"(",sprintf("%0.3f",norm1_T_sd),")"," & ",
...
x6 <- paste(sprintf("%0.3f",precision_min_mean),"(",sprintf("%0.3f",precision_min_sd),")"," & ",
...
x7 <- paste(sprintf("%0.3f",precision_star_desparsified_min_mean),"(",sprintf("%0.3f",precision_star_desparsified_min_sd),")"," & ",
...
x8 <- paste(sprintf("%0.3f",precision_star_method3_mean),"(",sprintf("%0.3f",precision_star_method3_sd),")"," & ",
