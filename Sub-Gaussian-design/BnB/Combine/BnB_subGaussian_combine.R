...
for(i in seed){
  dir <- paste("BnB_subGaussian/BnB_subGaussian_band_n",n,"_p",p,"_seed",i,".RData",sep="")
  load(file=dir)
  ...
  norm1_subGaussian_100 <- c(norm1_subGaussian_100,BnB_norm1)
  norm2_subGaussian_100 <- c(norm2_subGaussian_100,BnB_norm2)
  normF_subGaussian_100 <- c(normF_subGaussian_100,BnB_normF)
  normmax_subGaussian_100 <- c(normmax_subGaussian_100,BnB_normmax)
  
  BnBtime_subGaussian <- rbind(BnBtime_subGaussian,BnB_time)
  
  rm(precision,sensitivity,specificity,MCC,BnB_norm1,BnB_norm2,BnB_normF,BnB_normmax,BnB_time)
}
...
BnBtime_subGaussian_mean <- apply(BnBtime_subGaussian,2,mean)
...
BnBtime_subGaussian_sd <- apply(BnBtime_subGaussian,2,sd)
...
BnBtime_subGaussian_mean
BnBtime_subGaussian_sd
