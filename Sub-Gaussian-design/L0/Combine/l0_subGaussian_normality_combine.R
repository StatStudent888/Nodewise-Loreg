...
ltrue_desparsified <- ltrue_subGaussian_desparsified
...
load_function_desparsified <- function(shu,seed,n,p){
  i <- seed[shu]
  dir <- paste("l0_desparsified_unbias_subGaussian_normality/L0_desparsified_unbias_subGaussian_band_n",n,"_p",p,"_seed",i,"_normality.RData",sep="")
  load(file=dir)
...
# load_function_desparsified <- function(shu,seed,n,p){
#   i <- seed[shu]
#   dir <- paste("l0_desparsified_unbias_subGaussian_normality/L0_desparsified_unbias_subGaussian_random_n",n,"_p",p,"_seed",i,"_normality.RData",sep="")
#   load(file=dir)
#   
#   z_matrix <- matrix(0,nrow=p,ncol=p)
#   z_matrix[which(upper.tri(z_matrix, diag = TRUE))] <- z_desparsified
...
# load_function_desparsified <- function(shu,seed,n,p){
#   i <- seed[shu]
#   dir <- paste("l0_desparsified_unbias_subGaussian_normality/L0_desparsified_unbias_subGaussian_hub_n",n,"_p",p,"_seed",i,"_normality.RData",sep="")
#   load(file=dir)
#   
#   z_matrix <- matrix(0,nrow=p,ncol=p)
#   z_matrix[which(upper.tri(z_matrix, diag = TRUE))] <- z_desparsified
...
# load_function_desparsified <- function(shu,seed,n,p){
#   i <- seed[shu]
#   dir <- paste("l0_desparsified_unbias_subGaussian_normality/L0_desparsified_unbias_subGaussian_cluster_n",n,"_p",p,"_seed",i,"_normality.RData",sep="")
#   load(file=dir)
#   
#   z_matrix <- matrix(0,nrow=p,ncol=p)
#   z_matrix[which(upper.tri(z_matrix, diag = TRUE))] <- z_desparsified
...
ltrue_S0_ij_mean <- apply(ltrue_desparsified100[S0,],1,function(x) mean(x, na.rm = TRUE))
ltrue_S0C_ij_mean <- apply(ltrue_desparsified100[S0C,],1,function(x) mean(x, na.rm = TRUE))
ltrue_ground_ij_mean <- apply(ltrue_desparsified100[ground_support,],1,function(x) mean(x, na.rm = TRUE))
...
lengthtrue_S0_mean <- mean(ltrue_S0_ij_mean,na.rm = TRUE)
lengthtrue_S0C_mean <- mean(ltrue_S0C_ij_mean,na.rm = TRUE)
lengthtrue_ground_mean <- mean(ltrue_ground_ij_mean,na.rm = TRUE)
...
lengthtrue_S0_sd <- sd(ltrue_S0_ij_mean,na.rm = TRUE)
lengthtrue_S0C_sd <- sd(ltrue_S0C_ij_mean,na.rm = TRUE)
lengthtrue_ground_sd <- sd(ltrue_ground_ij_mean,na.rm = TRUE)
...
#For every (i,j), compute mean of asymptotic normality results over 100 replications
z_unbias_ij_mean <- abs(apply(z_unbias100,1,function(x) mean(x, na.rm = TRUE)))
z_unbias_ij_sd <- apply(z_unbias100,1,function(x) sd(x, na.rm = TRUE))
l_unbias_ij_mean <- apply(l_unbias100,1,function(x) mean(x, na.rm = TRUE))
ltrue_unbias_ij_mean <- apply(ltrue_unbias100,1,function(x) mean(x, na.rm = TRUE))
cov_unbias_ij_mean <- apply(cov_unbias100,1,function(x) mean(x, na.rm = TRUE))

#compute mean of asymptotic normality results over S_hat_Omega
coverage_rate_unbias_mean <- mean(cov_unbias_ij_mean,na.rm = TRUE)
abs_dif_unbias_mean <- mean(z_unbias_ij_mean,na.rm = TRUE)
z_sd_unbias_mean <- mean(z_unbias_ij_sd,na.rm = TRUE)
length_unbias_mean <- mean(l_unbias_ij_mean,na.rm = TRUE)
lengthtrue_unbias_mean <- mean(ltrue_unbias_ij_mean,na.rm = TRUE)

#compute sd of asymptotic normality results over S_hat_Omega
coverage_rate_unbias_sd <- sd(cov_unbias_ij_mean,na.rm = TRUE)
abs_dif_unbias_sd <- sd(z_unbias_ij_mean,na.rm = TRUE)
z_sd_unbias_sd <- sd(z_unbias_ij_sd,na.rm = TRUE)
length_unbias_sd <- sd(l_unbias_ij_mean,na.rm = TRUE)
lengthtrue_unbias_sd <- sd(ltrue_unbias_ij_mean,na.rm = TRUE)
