...
save(count_mean,count_sd,count_median,flag_mean,iter_count,file=paste("L0_subGaussian_band_n",n,"_p",p,"_seed",seed,"_NumOfIter.RData",sep=""))

# save(count_mean,count_sd,count_median,flag_mean,iter_count,file=paste("L0_subGaussian_random_n",n,"_p",p,"_seed",seed,"_NumOfIter.RData",sep=""))
# 
# save(count_mean,count_sd,count_median,flag_mean,iter_count,file=paste("L0_subGaussian_hub_n",n,"_p",p,"_seed",seed,"_NumOfIter.RData",sep=""))
# 
# save(count_mean,count_sd,count_median,flag_mean,iter_count,file=paste("L0_subGaussian_cluster_n",n,"_p",p,"_seed",seed,"_NumOfIter.RData",sep=""))
