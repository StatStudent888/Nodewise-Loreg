...
result <- L1_desparsified_confidence_intervals_SubGaussian(sdar_T,sdar_F_sigma,omega2,dataSigma2,n,p,alpha)
...
save(Ahat,cov_desparsified,z_desparsified,l_desparsified,cov_unbias,z_unbias,l_unbias,ltrue_unbias,file=paste("L0_desparsified_unbias_subGaussian_band_n",n,"_p",p,"_seed",seed,"_normality.RData",sep=""))

# save(Ahat,cov_desparsified,z_desparsified,l_desparsified,cov_unbias,z_unbias,l_unbias,ltrue_unbias,file=paste("L0_desparsified_unbias_subGaussian_random_n",n,"_p",p,"_seed",seed,"_normality.RData",sep=""))
# 
# save(Ahat,cov_desparsified,z_desparsified,l_desparsified,cov_unbias,z_unbias,l_unbias,ltrue_unbias,file=paste("L0_desparsified_unbias_subGaussian_hub_n",n,"_p",p,"_seed",seed,"_normality.RData",sep=""))
# 
# save(Ahat,cov_desparsified,z_desparsified,l_desparsified,cov_unbias,z_unbias,l_unbias,ltrue_unbias,file=paste("L0_desparsified_unbias_subGaussian_cluster_n",n,"_p",p,"_seed",seed,"_normality.RData",sep=""))
