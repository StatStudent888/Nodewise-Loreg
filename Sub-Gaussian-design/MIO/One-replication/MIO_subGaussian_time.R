...
save(precision,sensitivity,specificity,MCC,MIO_norm1,MIO_norm2,MIO_normF,MIO_normmax,MIO_time,file=paste("MIO_subGaussian_band_n",n,"_p",p,"_seed",seed,".RData",sep=""))

# save(precision,sensitivity,specificity,MCC,MIO_norm1,MIO_norm2,MIO_normF,MIO_normmax,MIO_time,file=paste("MIO_subGaussian_random_n",n,"_p",p,"_seed",seed,".RData",sep=""))
# 
# save(precision,sensitivity,specificity,MCC,MIO_norm1,MIO_norm2,MIO_normF,MIO_normmax,MIO_time,file=paste("MIO_subGaussian_hub_n",n,"_p",p,"_seed",seed,".RData",sep=""))
# 
# save(precision,sensitivity,specificity,MCC,MIO_norm1,MIO_norm2,MIO_normF,MIO_normmax,MIO_time,file=paste("MIO_subGaussian_cluster_n",n,"_p",p,"_seed",seed,".RData",sep=""))
