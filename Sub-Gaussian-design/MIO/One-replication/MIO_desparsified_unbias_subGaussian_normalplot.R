...
MIO_T<-MIO_F_sigma+t(MIO_F_sigma)-matrixMultiply(TT,MIO_F_sigma) #Desparsified estimator
...
dataSigma <- matrixMultiply(data,MIO_F_sigma)
...
while(j<p){
  ...
  if(nj==0){next}
  for(i in 1:nj){
    T_hat_ij <- MIO_T[,j][Ajhat][i]
    theta_hat_ij <- MIO_F_sigma[,j][Ajhat][i] #代入未对称化的theta_hat_ij
    theta_hat_ji <- t(MIO_F_sigma)[,j][Ajhat][i] #代入未对称化的theta_hat_ji
...
save(Ahat,z_unbias,z_desparsified,file=paste("MIO_desparsified_unbias_subGaussian_band_n",n,"_p",p,"_seed",seed,"_normalplot.RData",sep=""))

# save(Ahat,z_unbias,z_desparsified,file=paste("MIO_desparsified_unbias_subGaussian_random_n",n,"_p",p,"_seed",seed,"_normalplot.RData",sep=""))
# 
# save(Ahat,z_unbias,z_desparsified,file=paste("MIO_desparsified_unbias_subGaussian_hub_n",n,"_p",p,"_seed",seed,"_normalplot.RData",sep=""))
# 
# save(Ahat,z_unbias,z_desparsified,file=paste("MIO_desparsified_unbias_subGaussian_cluster_n",n,"_p",p,"_seed",seed,"_normalplot.RData",sep=""))
