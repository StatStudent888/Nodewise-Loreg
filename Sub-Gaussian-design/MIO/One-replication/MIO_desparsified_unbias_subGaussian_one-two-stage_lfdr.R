...
while(j<p){
  ...
  if(nj==0){next}
  for(i in 1:nj){
    B <- solve(X_plus2[Ajhat_plus,Ajhat_plus])
    iAjhat <- which(Ajhat_plus==(Ajhat[i]+1))
    theta_hat_ij <- MIO_F_sigma3[-j,j][Ajhat][i] 
    theta_hat_ji <- t(MIO_F_sigma3)[-j,j][Ajhat][i] 
    sigmahat_ij_lowertri2_left <- (((B[iAjhat,])%*%t(as.matrix(X_plus[,Ajhat_plus])))^2%*%(as.matrix(X_plus[,Ajhat_plus])%*%(as.matrix(B[,jAjhat])))^2)/n
    ...
    if(sigmahat_ij_lowertri2<=0){
      ...
      sigmahat_ij_lowertri <- sqrt(sigmahat_ij_lowertri2_fix)
    }
    else{sigmahat_ij_lowertri <- sqrt(sigmahat_ij_lowertri2)}
...
dataSigma <- matrixMultiply(data,MIO_F_sigma3)
...
zvalue_low <- computeZValueLowSubGaussian(MIO_T,MIO_F_sigma3,dataSigma2,n,p)
...
save(precision_min,precision_star_unbias_min,
     ...
     MIO_normF_T_star_method3,MIO_normmax_T_star_method3,file=paste("MIO_desparsified_unbias_subGaussian_band_n",n,"_p",p,"_seed",seed,"_one-two-stage_lfdr.RData",sep=""))
...
#      MIO_normmax_T_star_desparsified_min_method2,
#      MIO_norm1_T_star_method3,MIO_norm2_T_star_method3,
#      MIO_normF_T_star_method3,MIO_normmax_T_star_method3,file=paste("MIO_desparsified_unbias_subGaussian_random_n",n,"_p",p,"_seed",seed,"_one-two-stage_lfdr.RData",sep=""))
# 
# save(precision_min,precision_star_unbias_min,
#      sensitivity_min,sensitivity_star_unbias_min,specificity_min,
#      specificity_star_unbias_min,MCC_min,MCC_star_unbias_min,F1_min,F1_star_unbias_min,
...
#      MIO_normmax_T_star_desparsified_min_method2,
#      MIO_norm1_T_star_method3,MIO_norm2_T_star_method3,
#      MIO_normF_T_star_method3,MIO_normmax_T_star_method3,file=paste("MIO_desparsified_unbias_subGaussian_hub_n",n,"_p",p,"_seed",seed,"_one-two-stage_lfdr.RData",sep=""))
# 
# save(precision_min,precision_star_unbias_min,
#      sensitivity_min,sensitivity_star_unbias_min,specificity_min,
#      specificity_star_unbias_min,MCC_min,MCC_star_unbias_min,F1_min,F1_star_unbias_min,
...
#      MIO_normmax_T_star_desparsified_min_method2,
#      MIO_norm1_T_star_method3,MIO_norm2_T_star_method3,
#      MIO_normF_T_star_method3,MIO_normmax_T_star_method3,file=paste("MIO_desparsified_unbias_subGaussian_cluster_n",n,"_p",p,"_seed",seed,"_one-two-stage_lfdr.RData",sep=""))
