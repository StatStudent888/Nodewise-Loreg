...
for(i in seed){
  dir <- paste("MIO_subGaussian_normalplot/MIO_desparsified_unbias_subGaussian_band_n",n,"_p",p,"_seed",i,"_normalplot.RData",sep="")
  load(file=dir)
...
save(omega_support,file=paste("MIO_subGaussian_band_p",p,"_supportset_of_normalplot.RData",sep=""))


p <- 200
load(file=paste("MIO_subGaussian_band_p",p,"_supportset_of_normalplot.RData",sep=""))
