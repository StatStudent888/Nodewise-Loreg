...
cov_desparsified100 <- {}
for(i in seed){
  dir <- paste("l0_desparsified_unbias_Gaussian_normality_output/L0_desparsified_unbias_Gaussian_band_n",n,"_p",p,"_seed",i,"_normality.RData",sep="")
  load(file=dir)
...
save.image(paste("L0_desparsified_unbias_Gaussian_band_n",n,"_p",p,"_normality.RData",sep=""))
