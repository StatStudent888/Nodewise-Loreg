...
for(i in seed){
  dir <- paste("L0_Gaussian_normalplot_output/L0_desparsified_unbias_Gaussian_band_n",n,"_p",p,"_seed",i,"_normalplot.RData",sep="")
  load(file=dir)
...
save(omega_support,file=paste("L0_Gaussian_band_p",p,"_supportset_of_normalplot.RData",sep=""))
...
save.image(paste("L0_desparsified_unbias_Gaussian_band_n",n,"_p",p,"_normalplot.RData",sep=""))
