...
for(i in seed){
  dir <- paste("l1_desparsified_Gaussian_one-two-stage_lfdr_output/L1_desparsified_Gaussian_band_n",n,"_p",p,"_seed",i,"_one-two-stage_lfdr.RData",sep="")
  load(file=dir)
...
save.image(paste("L1_desparsified_Gaussian_band_n",n,"_p",p,"_one-two-stage_lfdr.RData",sep=""))