...
while(j<p){
  ...
  for(i in 1:nj){
    ...
    sigmahat_ij2 <- as.matrix(NS_F_sigma3[-j,-j][Ajhat,Ajhat])[i,i]*sigma[j]+theta_hat_ij^2
    sigmahat_ji2 <- as.matrix(NS_F_sigma3[-j,-j][Ajhat,Ajhat])[i,i]*sigma[j]+theta_hat_ji^2
...
for(j in 1:p){
  for(i in 1:p){
    if(i>j){
      T_hat_ij <- NS_T[i,j]
      sigmahat_ij2 <- NS_F_sigma3[i,i]*NS_F_sigma3[j,j]+(NS_F_sigma3[i,j])^2
      sigmahat_ji2 <- NS_F_sigma3[i,i]*NS_F_sigma3[j,j]+(NS_F_sigma3[j,i])^2
      sigmahat_ij_lowertri <- sqrt((sigmahat_ij2+sigmahat_ji2)/2)
...
save(data,NS_F_sigma1,NS_F_sigma3,NS_T,
     ...
     NS_normF_T_star_method3,NS_normmax_T_star_method3,file=paste("L1_desparsified_Gaussian_band_n",n,"_p",p,"_seed",seed,"_one-two-stage_lfdr.RData",sep=""))
...
#      NS_normmax_T_star_desparsified_min_method2,
#      NS_norm1_T_star_method3,NS_norm2_T_star_method3,
#      NS_normF_T_star_method3,NS_normmax_T_star_method3,file=paste("L1_desparsified_Gaussian_random_n",n,"_p",p,"_seed",seed,"_one-two-stage_lfdr.RData",sep=""))
...
#      NS_normmax_T_star_desparsified_min_method2,
#      NS_norm1_T_star_method3,NS_norm2_T_star_method3,
#      NS_normF_T_star_method3,NS_normmax_T_star_method3,file=paste("L1_desparsified_Gaussian_hub_n",n,"_p",p,"_seed",seed,"_one-two-stage_lfdr.RData",sep=""))
...
#      NS_normmax_T_star_desparsified_min_method2,
#      NS_norm1_T_star_method3,NS_norm2_T_star_method3,
#      NS_normF_T_star_method3,NS_normmax_T_star_method3,file=paste("L1_desparsified_Gaussian_cluster_n",n,"_p",p,"_seed",seed,"_one-two-stage_lfdr.RData",sep=""))