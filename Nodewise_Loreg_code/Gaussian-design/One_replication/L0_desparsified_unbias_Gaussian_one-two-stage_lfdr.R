...
while(j<p){
  ...
  for(i in 1:nj){
    ...
    sigmahat_ij_lowertri <- sqrt((solve((t(X_plus)%*%X_plus/n)[Ajhat_plus,Ajhat_plus])[iAjhat,iAjhat])*(solve((t(X_plus)%*%X_plus/n)[Ajhat_plus,Ajhat_plus])[jAjhat,jAjhat])+(solve((t(X_plus)%*%X_plus/n)[Ajhat_plus,Ajhat_plus])[iAjhat,jAjhat])^2)
...
while(j<p){
  ...
  for(i in 1:nj){
    ...
    sigmahat_ij2 <- as.matrix(sdar_F_sigma3[-j,-j][Ajhat,Ajhat])[i,i]*sigma[j]+theta_hat_ij^2
    sigmahat_ji2 <- as.matrix(sdar_F_sigma3[-j,-j][Ajhat,Ajhat])[i,i]*sigma[j]+theta_hat_ji^2
...
for(j in 1:p){
  for(i in 1:p){
    if(i>j){
      T_hat_ij <- sdar_T[i,j]
      sigmahat_ij2 <- sdar_F_sigma3[i,i]*sdar_F_sigma3[j,j]+(sdar_F_sigma3[i,j])^2
      sigmahat_ji2 <- sdar_F_sigma3[i,i]*sdar_F_sigma3[j,j]+(sdar_F_sigma3[j,i])^2
      sigmahat_ij_lowertri <- sqrt((sigmahat_ij2+sigmahat_ji2)/2)
...
save(data,sdar_F_sigma1,sdar_F_sigma3,sdar_T,
     ...
     sdar_normF_T_star_method3,sdar_normmax_T_star_method3,file=paste("L0_desparsified_unbias_Gaussian_band_n",n,"_p",p,"_seed",seed,"_one-two-stage_lfdr.RData",sep=""))
...
#      sdar_normmax_T_star_desparsified_min_method2,
#      sdar_norm1_T_star_method3,sdar_norm2_T_star_method3,
#      sdar_normF_T_star_method3,sdar_normmax_T_star_method3,file=paste("L0_desparsified_unbias_Gaussian_random_n",n,"_p",p,"_seed",seed,"_one-two-stage_lfdr.RData",sep=""))
...
#      sdar_normmax_T_star_desparsified_min_method2,
#      sdar_norm1_T_star_method3,sdar_norm2_T_star_method3,
#      sdar_normF_T_star_method3,sdar_normmax_T_star_method3,file=paste("L0_desparsified_unbias_Gaussian_hub_n",n,"_p",p,"_seed",seed,"_one-two-stage_lfdr.RData",sep=""))
...
#      sdar_normmax_T_star_desparsified_min_method2,
#      sdar_norm1_T_star_method3,sdar_norm2_T_star_method3,
#      sdar_normF_T_star_method3,sdar_normmax_T_star_method3,file=paste("L0_desparsified_unbias_Gaussian_cluster_n",n,"_p",p,"_seed",seed,"_one-two-stage_lfdr.RData",sep=""))