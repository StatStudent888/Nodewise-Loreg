...
CLIMEtime_Gaussian <- {}
CLIMEtime_subGaussian <- {}


for(i in seed){
  dir <- paste("CLIME_time_output/CLIME_band_n",n,"_p",p,"_seed",i,".RData",sep="")
  load(file=dir)
  
  eva_Gaussian <- evaluation(omega2,CLIME_F_sigma_Gaussian)
  eva_subGaussian <- evaluation(omega2,CLIME_F_sigma_subGaussian)
  ...
  norm1_Gaussian <- norm(CLIME_F_sigma_Gaussian-omega2,"1")
  norm1_subGaussian <- norm(CLIME_F_sigma_subGaussian-omega2,"1")
  norm1_Gaussian_100 <- c(norm1_Gaussian_100,norm1_Gaussian)
  norm1_subGaussian_100 <- c(norm1_subGaussian_100,norm1_subGaussian)
  norm2_Gaussian <- norm(CLIME_F_sigma_Gaussian-omega2,"2")
  norm2_subGaussian <- norm(CLIME_F_sigma_subGaussian-omega2,"2")
  norm2_Gaussian_100 <- c(norm2_Gaussian_100,norm2_Gaussian)
  norm2_subGaussian_100 <- c(norm2_subGaussian_100,norm2_subGaussian)
  normF_Gaussian <- norm(CLIME_F_sigma_Gaussian-omega2,"F")
  normF_subGaussian <- norm(CLIME_F_sigma_subGaussian-omega2,"F")
  normF_Gaussian_100 <- c(normF_Gaussian_100,normF_Gaussian)
  normF_subGaussian_100 <- c(normF_subGaussian_100,normF_subGaussian)
  normmax_Gaussian <- norm(CLIME_F_sigma_Gaussian-omega2,"M")
  normmax_subGaussian <- norm(CLIME_F_sigma_subGaussian-omega2,"M")
  ...
  CLIMEtime_Gaussian <- rbind(CLIMEtime_Gaussian,timek_Gaussian)
  CLIMEtime_subGaussian <- rbind(CLIMEtime_subGaussian,timek_subGaussian)
  
  rm(data_Gaussian,data_subGaussian,CLIME_F_sigma_Gaussian,CLIME_F_sigma_subGaussian,timek_Gaussian,timek_subGaussian)
}
...
CLIMEtime_Gaussian_mean <- apply(CLIMEtime_Gaussian,2,mean)
CLIMEtime_subGaussian_mean <- apply(CLIMEtime_subGaussian,2,mean)
...
CLIMEtime_Gaussian_sd <- apply(CLIMEtime_Gaussian,2,sd)
CLIMEtime_subGaussian_sd <- apply(CLIMEtime_subGaussian,2,sd)
...
CLIMEtime_Gaussian_mean
CLIMEtime_Gaussian_sd

x3

x4

CLIMEtime_subGaussian_mean
CLIMEtime_subGaussian_sd

save.image(paste("CLIME_Gaussian_subGaussian_band_n",n,"_p",p,"_all.RData",sep=""))