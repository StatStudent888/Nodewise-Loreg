...
cov_desparsified100 <- {}
for(i in seed){
  dir <- paste("l1_desparsified_subGaussian_normality_output/L1_desparsified_subGaussian_band_n",n,"_p",p,"_seed",i,"_normality.RData",sep="")
  load(file=dir)
...
save.image(paste("L1_desparsified_subGaussian_band_n",n,"_p",p,"_normality.RData",sep=""))