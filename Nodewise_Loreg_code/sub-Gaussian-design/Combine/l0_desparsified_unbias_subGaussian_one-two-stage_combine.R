...
for(i in seed){
  dir <- paste("l0_desparsified_unbias_subGaussian_one-two-stage_lfdr_output/L0_desparsified_unbias_subGaussian_band_n",n,"_p",p,"_seed",i,"_one-two-stage_lfdr.RData",sep="")
  load(file=dir)
...
save.image(paste("L0_desparsified_unbias_subGaussian_band_n",n,"_p",p,"_one-two-stage_lfdr.RData",sep=""))
