...
for(i in seed){
  dir <- paste("l1_desparsified_subGaussian_one-two-stage_lfdr_output/L1_desparsified_subGaussian_band_n",n,"_p",p,"_seed",i,"_one-two-stage_lfdr.RData",sep="")
  load(file=dir)
  ...
  rm(data,NS_F_sigma1,NS_F_sigma3,NS_T,
...
x1 <- paste(sprintf("%0.3f",precision_min_mean),"(",sprintf("%0.3f",precision_min_sd),")"," / ",sprintf("%0.3f",precision_star_desparsified_min_mean),"(",sprintf("%0.3f",precision_star_desparsified_min_sd),")"," & ",
...
x2 <- paste(sprintf("%0.3f",precision_star_method3_mean),"(",sprintf("%0.3f",precision_star_method3_sd),")"," & ",
...
x3 <- paste(sprintf("%0.3f",norm1_min_mean),"(",sprintf("%0.3f",norm1_min_sd),")"," / ",sprintf("%0.3f",norm1_star_desparsified_min_method1_mean),"(",sprintf("%0.3f",norm1_star_desparsified_min_method1_sd),")"," & ",
...
save.image(paste("L1_desparsified_subGaussian_band_n",n,"_p",p,"_one-two-stage_lfdr.RData",sep=""))