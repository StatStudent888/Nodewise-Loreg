...
z_100 <- {}
for(i in seed){
  dir <- paste("L1_subGaussian_normalplot_output/L1_desparsified_subGaussian_band_n",n,"_p",p,"_seed",i,"_normalplot.RData",sep="")
  load(file=dir)
...
save.image(paste("L1_desparsified_subGaussian_band_n",n,"_p",p,"_normalplot.RData",sep=""))