...
timek_Gaussian<-system.time({
  ...
  for(j in 1:20){  
    l=Lambda[j]
    CLIME= sugm(X_Gaussian, lambda =l,method = "clime",sym="and",verbose = FALSE)
    fit_wi<-CLIME[["icov"]][[1]]
  ...
  CLIME_F_sigma_Gaussian<- Bestwi_Gaussian[[id_Gaussian]]
  CLIME_F_sigma_Gaussian<- as.matrix(CLIME_F_sigma_Gaussian)}) 
...
timek_subGaussian<-system.time({
  ...
  for(j in 1:20){  
    l=Lambda[j]
    CLIME= sugm(X_subGaussian, lambda =l,method = "clime",sym="and",verbose = FALSE)
    fit_wi<-CLIME[["icov"]][[1]]
  ...
  CLIME_F_sigma_subGaussian<- Bestwi_subGaussian[[id_subGaussian]]
  CLIME_F_sigma_subGaussian<- as.matrix(CLIME_F_sigma_subGaussian)}) 


save(data_Gaussian,data_subGaussian,CLIME_F_sigma_Gaussian,CLIME_F_sigma_subGaussian,timek_Gaussian,timek_subGaussian,file=paste("CLIME_band_n",n,"_p",p,"_seed",seed,".RData",sep=""))

#save(data_Gaussian,data_subGaussian,CLIME_F_sigma_Gaussian,CLIME_F_sigma_subGaussian,timek_Gaussian,timek_subGaussian,file=paste("CLIME_random_n",n,"_p",p,"_seed",seed,".RData",sep=""))

#save(data_Gaussian,data_subGaussian,CLIME_F_sigma_Gaussian,CLIME_F_sigma_subGaussian,timek_Gaussian,timek_subGaussian,file=paste("CLIME_hub_n",n,"_p",p,"_seed",seed,".RData",sep=""))

#save(data_Gaussian,data_subGaussian,CLIME_F_sigma_Gaussian,CLIME_F_sigma_subGaussian,timek_Gaussian,timek_subGaussian,file=paste("CLIME_cluster_n",n,"_p",p,"_seed",seed,".RData",sep=""))