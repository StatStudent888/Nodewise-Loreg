...
save(timek_Gaussian,timek_subGaussian,file=paste("L1_band_n",n,"_p",p,"_seed",seed,"_time.RData",sep=""))

# save(timek_Gaussian,timek_subGaussian,file=paste("L1_random_n",n,"_p",p,"_seed",seed,"_time.RData",sep=""))
# 
# save(timek_Gaussian,timek_subGaussian,file=paste("L1_hub_n",n,"_p",p,"_seed",seed,"_time.RData",sep=""))
# 
# save(timek_Gaussian,timek_subGaussian,file=paste("L1_cluster_n",n,"_p",p,"_seed",seed,"_time.RData",sep=""))