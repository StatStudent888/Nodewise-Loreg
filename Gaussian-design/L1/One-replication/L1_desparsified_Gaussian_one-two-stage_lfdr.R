...
zvalue_desparsified_min <- computeZValueDesparsifiedGaussian(NS_F_lowertri1,NS_T,NS_F_sigma3,sigma,n,p)
...
zvalue_low <- computeZValueLowGaussian(NS_T,NS_F_sigma3,n,p)
