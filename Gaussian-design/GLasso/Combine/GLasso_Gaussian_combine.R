...
for(i in seed){
  dir <- paste("GLasso_Gaussian/Glasso_Gaussian_band_n",n,"_p",p,"_seed",i,".RData",sep="")
  load(file=dir)
  ...
  norm1_Gaussian_100 <- c(norm1_Gaussian_100,Glasso_norm1)
  norm2_Gaussian_100 <- c(norm2_Gaussian_100,Glasso_norm2)
  normF_Gaussian_100 <- c(normF_Gaussian_100,Glasso_normF)
  normmax_Gaussian_100 <- c(normmax_Gaussian_100,Glasso_normmax)
  
  Glassotime_Gaussian <- rbind(Glassotime_Gaussian,Glasso_time)
