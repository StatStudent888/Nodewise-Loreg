...
save(precision,sensitivity,specificity,MCC,Glasso_norm1,Glasso_norm2,Glasso_normF,Glasso_normmax,Glasso_time,file=paste("Glasso_Gaussian_band_n",n,"_p",p,"_seed",seed,".RData",sep=""))

# save(precision,sensitivity,specificity,MCC,Glasso_norm1,Glasso_norm2,Glasso_normF,Glasso_normmax,Glasso_time,file=paste("Glasso_Gaussian_random_n",n,"_p",p,"_seed",seed,".RData",sep=""))
# 
# save(precision,sensitivity,specificity,MCC,Glasso_norm1,Glasso_norm2,Glasso_normF,Glasso_normmax,Glasso_time,file=paste("Glasso_Gaussian_hub_n",n,"_p",p,"_seed",seed,".RData",sep=""))
# 
# save(precision,sensitivity,specificity,MCC,Glasso_norm1,Glasso_norm2,Glasso_normF,Glasso_normmax,Glasso_time,file=paste("Glasso_Gaussian_cluster_n",n,"_p",p,"_seed",seed,".RData",sep=""))
