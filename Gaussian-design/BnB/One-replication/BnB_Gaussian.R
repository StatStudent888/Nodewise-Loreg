...
save(precision,sensitivity,specificity,MCC,BnB_norm1,BnB_norm2,BnB_normF,BnB_normmax,BnB_time,file=paste("BnB_Gaussian_band_n",n,"_p",p,"_seed",seed,".RData",sep=""))

# save(precision,sensitivity,specificity,MCC,BnB_norm1,BnB_norm2,BnB_normF,BnB_normmax,BnB_time,file=paste("BnB_Gaussian_random_n",n,"_p",p,"_seed",seed,".RData",sep=""))
# 
# save(precision,sensitivity,specificity,MCC,BnB_norm1,BnB_norm2,BnB_normF,BnB_normmax,BnB_time,file=paste("BnB_Gaussian_hub_n",n,"_p",p,"_seed",seed,".RData",sep=""))
# 
# save(precision,sensitivity,specificity,MCC,BnB_norm1,BnB_norm2,BnB_normF,BnB_normmax,BnB_time,file=paste("BnB_Gaussian_cluster_n",n,"_p",p,"_seed",seed,".RData",sep=""))
