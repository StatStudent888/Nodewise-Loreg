...
for(i in seed){
  dir <- paste("BnB_Gaussian/BnB_Gaussian_band_n",n,"_p",p,"_seed",i,".RData",sep="")
  load(file=dir)
  ...
  norm1_Gaussian_100 <- c(norm1_Gaussian_100,BnB_norm1)
  norm2_Gaussian_100 <- c(norm2_Gaussian_100,BnB_norm2)
  normF_Gaussian_100 <- c(normF_Gaussian_100,BnB_normF)
  normmax_Gaussian_100 <- c(normmax_Gaussian_100,BnB_normmax)
  
  BnBtime_Gaussian <- rbind(BnBtime_Gaussian,BnB_time)
...
BnBtime_Gaussian_mean <- apply(BnBtime_Gaussian,2,mean)
...
BnBtime_Gaussian_sd <- apply(BnBtime_Gaussian,2,sd)
