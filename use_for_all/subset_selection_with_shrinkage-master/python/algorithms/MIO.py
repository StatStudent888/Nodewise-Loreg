...
# Setup the MIO model in Gurobi/Python
    ...
    MIO_L0_LQ = Model("MIO", env=env)
    MIO_L0_LQ.setParam('TimeLimit', time_limit)
    MIO_L0_LQ.setParam('Threads', 1)
    MIO_L0_LQ.setParam('Seed', 0)
...
#---Solve the Model that we set up
    ...
    if MIO_L0_LQ.Status == GRB.INFEASIBLE:
        print("模型无可行解！")
        MIO_L0_LQ.computeIIS()
        MIO_L0_LQ.write("infeasible_constraints.ilp")
