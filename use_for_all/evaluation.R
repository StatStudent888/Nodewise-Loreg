...
evaluation <- function(theta,theta_hat){
  ...
  TP <- as.numeric(sum((abs(theta)>0.00001)*(theta_hat!=0)))
  FP <- as.numeric(sum((abs(theta)<=0.00001)*(theta_hat!=0)))
  FN <- as.numeric(sum((abs(theta)>0.00001)*(theta_hat==0)))
  TN <- as.numeric(sum((abs(theta)<=0.00001)*(theta_hat==0)))
